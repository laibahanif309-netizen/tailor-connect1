      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          >
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, flex: 1 }}>
              ...
              <View style={styles.rowText}>
                ...
                <Text style={styles.rowSub}>Name, phone, and business profile</Text>
              </View>
            </View>
          ...
          <Pressable
            ...
            onPress={() => router.push('/(tailor)/change-password')}
            accessibilityRole="button"
          ...
          >
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, flex: 1 }}>
              ...
              <View style={styles.rowText}>
                ...
                <Text style={styles.rowSub}>Orders, chat, and home visits</Text>
              </View>
            </View>
            <MaterialCommunityIcons name="chevron-right" size={22} color={colors.chevron} />
          </Pressable>
